...
<script>
    ...
    function addData() {
        ...
        $(".modal-title").text("Add Department Data");
    ...
    $("#form-department").submit(function(e) {
        ...
        e.preventDefault();
        var id = $('#id').val();
        if (save_method == "add") url = "{{ url('/department') }}";
        else url = "{{ url('/department') . '/' }}" + id;
        $.ajax({
            url: url,
            type: "POST",
    ...
    function editData(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#modal-add').modal("show");
                $('.modal-title').text("Edit Department Data");
                $('#id').val(data.id);
                $("#name").val(data.name);
            }
        })
