        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xl-6">
                <div class="card card-block card-stretch card-height">
                    ...
                    <div class="card-body ">
                         <div class="d-flex  "> $82,944.60
                        <div class="text-success ml-2">75 %
                                ...
                                <div class="row">
                                        ...
                                        <div class=" d-flex align-items-center">
                                            <div class="border bg-primary rounded iq-icon-box">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                    fill="currentColor" height="26px" width="26px" class="mb-1">
                                                    <path fill-rule="evenodd"
                                    ...
                                    <div class="col-lg-6 ml-auto pl-0 pr-0 col-md-6">
                                        <div class="bottom-img ">
                                            <img src="{{ asset('images/product/131.png') }}" class="" alt="image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ul class="list-inline p-0 mb-0">
                            <li class="mb-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="iq-icon-box1  rounded mr-3">
                                        <img src="{{ asset('images/product/1.png') }}" class="img-fluid rounded avatar-45 m-auto"
                                            alt="image">
                                    </div>
                            ...
                            <li class="mb-4">
                                <div class="d-flex align-items-center justify-content-between ">
                                    ...
                                    <div class="iq-icon-box1 rounded mr-3">
                                        <img src="{{ asset('images/product/3.png') }}" class="img-fluid rounded avatar-45 m-auto"
                                            alt="image">
                                    </div>
                                    <div class="w-100  p-md-0">
                                        <h6>Boult</h6>
                            ...
                            <li>
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="iq-icon-box1  rounded mr-3">
                                        <img src="{{ asset('images/product/2.png') }}" class="img-fluid rounded avatar-45 m-auto"
                                            alt="image">
                                    </div>
                                    <div class="w-100  p-md-0">
                                        <h6>Arning</h6>
