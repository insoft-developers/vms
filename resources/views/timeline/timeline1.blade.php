                              ...
                              <li>
                                 ...
                                 <div class="d-inline-block w-100">
                                    ...
                                    <div class="mm-media-group">
                                       <a href="#" class="mm-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/5.jpg")}} " alt="">
                                       </a>
                                       <a href="#" class="mm-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/6.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="mm-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/7.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="mm-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/2.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="mm-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/3.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="mm-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/1.jpg")}}  alt="">
                                       </a>
                                    </div>
                                 </div>
                              </li>
